...
=======
"""
1. Нормализовать словари в json и собрать нормальное кол-во слов в них.
2. Адаптировать и изменить некоторый дизайн на всех страницах.
3. Добавить 'изюминку' сайту.
4. Наладить систему оплаты.
5. Придумать цены на курсы и на какие из них будет скидка.
6. """
>>>>>>> b9fb5a10e7e50e5ab789c03b76f9233419e08afd
